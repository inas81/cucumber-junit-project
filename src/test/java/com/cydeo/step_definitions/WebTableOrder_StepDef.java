...
public class WebTableOrder_StepDef {
    ...
    public void user_selects_credit_card_type(String string) {
       // for (WebElement each:webTableOrderPage.inputCardType) {
          //  if(each.getAttribute("value").equalsIgnoreCase(string)){
         //       each.click();
        BrowserUtils.clickRadioButton(webTableOrderPage.inputCardType,string);
...
webTableOrderPage.processOrderButton.click();
    ...
    public void user_should_see_in_first_row_of_the_web_table(String expCustomerName) {
String act=viewAllOrdersPage.newCustomerCell.getText();

        Assert.assertEquals(expCustomerName,act);
